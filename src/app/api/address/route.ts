...
export async function POST(req: Request) {
   ...
   console.log('🔍 Extracted fields:', { country, province, city, postalCode, addressLine, isMain })

   if (!country || !province || !city || !postalCode || !addressLine) {
      console.error('🚨 Missing required fields!', { country, province, city, postalCode, addressLine })
